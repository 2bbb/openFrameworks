...
// ----------------------------------------------------------------------------
bool ofOpenALSoundPlayer::sfReadFile(const of::filesystem::path& path, vector<short> & buffer, vector<float> & fftAuxBuffer){
	SF_INFO sfInfo;
...
#ifdef OF_USING_MPG123
//------------------------------------------------------------
bool ofOpenALSoundPlayer::mpg123ReadFile(const of::filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	int err = MPG123_OK;
...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::sfStream(const of::filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	if(!streamf){
		SF_INFO sfInfo;
...
#ifdef OF_USING_MPG123
//------------------------------------------------------------
bool ofOpenALSoundPlayer::mpg123Stream(const of::filesystem::path& path,vector<short> & buffer,vector<float> & fftAuxBuffer){
	if(!mp3streamf){
		int err = MPG123_OK;
...
//------------------------------------------------------------
bool ofOpenALSoundPlayer::stream(const of::filesystem::path& fileName, vector<short> & buffer){
#ifdef OF_USING_MPG123
...
bool ofOpenALSoundPlayer::readFile(const of::filesystem::path& fileName, vector<short> & buffer){
#ifdef OF_USING_MPG123
...
bool ofOpenALSoundPlayer::load(const of::filesystem::path& _fileName, bool is_stream){
	...
	of::filesystem::path fileName = ofToDataPath(_fileName);
